...
import { v1 } from 'uuid';
import { StorageType, FormListSettings, ISuggest, Type, ColumnDef, DocumentBase, DocumentOptions, FormListFilter, FormListOrder } from '@x100group/jetti-middle/dist';
@Component({
